...
(function ($) {
  ...
  //education js
   ...
   document.getElementById("contactForm").addEventListener("submit", function (event) {
    ...
    emailjs.init("z3NbVwkWC12Y4LdBE"); // Replace with your EmailJS Public Key
  
    let serviceID = "service_slsicpu"; // Replace with your EmailJS Service ID
    let templateID = "template_lq75to4"; // Replace with your EmailJS Template ID
  
    let formData = {
      to_name: "VN HaularesTech Manikandan S",  // Your company or website name (recipient)
